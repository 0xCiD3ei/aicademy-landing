    ...
    <>
      ...
      >
        ...
        >
          <h2 className='text-center text-primary-foreground font-semibold text-sm md:text-2xl xl:text-5xl'>
            What is{' '}
            <span className='font-dela-gothic-one text-[36px] md:text-[60px] lg:text-[80px] leading-[120%] text-primary'>
              aicademy ?
            </span>
          </h2>
          <div
      ...
      <div className='bg-white flex items-center justify-center gap-2.5 md:gap-10 xl:gap-[103px] flex-col-reverse xl:flex-row py-10 px-5 xl:py-[146px]'>
        <div className='relative w-full max-w-[728px] aspect-[728/507]'>
          <div className='absolute inset-0 bg-[url(/svg/border-frame.svg)] w-full h-full bg-center bg-no-repeat bg-contain inline-flex items-center justify-center'>
            <div className='p-6 w-full h-full flex items-center justify-center'>
              <div className='text-black text-xs sm:text-[22px] sm:leading-8 w-[262px] sm:w-[400px] xl:w-[556.36px]'>
                Learning knows no limits with aicademy. Our AI Mentor is
                available 24/7, offering instant, context-aware support—whether
                you need clarity, feedback, or help crafting the perfect{' '}
                <span ref={textRef} className='relative'>
                  ...
                  />
                  <span className='relative underline font-semibold'>
                    AI prompt
                  </span>
        ...
        <div className='flex flex-col items-center xl:items-start justify-center text-center xl:text-left gap-2.5 md:gap-5 xl:gap-10 text-primary-foreground '>
  ...
  return (
    <div className='absolute -bottom-[50px] -right-[130px] sm:-bottom-[70px] sm:-right-[150px] xl:-bottom-[100px] translate-y-1/2 xl:-right-52 bg-[#D7E5E9] rounded-xl px-2 py-1.5 xl:py-[10px] xl:px-3 w-[127px] md:w-[150px] xl:w-[184px] h-auto'>
      <div className='flex flex-col'>
        <div className='bg-[#1AADB5] p-[5px] xl:p-2 flex items-center justify-between text-[10px] md:text-xs xl:text-sm leading-[120%] rounded text-white'>
          ...
          >
            <g clipPath='url(#clip0_15892_18507)'>
              ...
              />
              <path
                d='M5.375 7.12497H10.625M8 10.625H10.625'
                stroke='white'
                strokeWidth='1.75'
                strokeLinecap='round'
        ...
        <div className='p-[5px] xl:p-2 flex items-center justify-between text-[10px] md:text-xs xl:text-sm leading-[120%] rounded'>
          Give Examples
          <svg
            xmlns='http://www.w3.org/2000/svg'
            width='16'
        ...
        <div className='p-[5px] xl:p-2 flex items-center justify-between text-[10px] md:text-xs xl:text-sm leading-[120%] rounded'>
          ...
          >
            ...
            <defs>
              <pattern
                id='pattern0_15892_18526'
                patternContentUnits='objectBoundingBox'
                width='1'
                height='1'
              >
                <use
                  xlinkHref='#image0_15892_18526'
                  transform='scale(0.00195312)'
                />
              </pattern>
              <image
                id='image0_15892_18526'
                width='512'
                height='512'
  ...
  return (
    <div className='absolute bottom-[40px] left-[60%] md:right-0 xl:-bottom-2/3 xl:-right-1/3  -translate-x-1/2 xl:-translate-y-1/2 w-[230px] sm:w-[300px] sm:w-[360px] xl:w-[420px] h-auto bg-[#E1EEE9] rounded-3xl drop-shadow-[0px_3px_7px_rgba(0,0,0,0.1)]'>
        ...
        <div className='flex flex-col gap-1 sm:gap-2 xl:gap-4'>
          ...
          <div className='flex items-center gap-6'>
            ...
            <div className='flex items-center gap-2'>
              ...
              >
                <path
                  d='M2.66602 5.39667L3.7383 7.93275L6.26042 6.86642'
                  stroke='#776F69'
                  strokeWidth='1.33333'
                  strokeLinecap='round'
                  strokeLinejoin='round'
      ...
      <div className='absolute xl:hidden bottom-1 -left-3 translate-x-1/2 translate-y-1/2'>
        ...
        >
          <path
            d='M17.8982 6.40105L6.51378 0.152685L3.69501 8.1361L0.876252 16.1195L9.38725 11.2603L17.8982 6.40105Z'
            fill='#E1EEE9'
          />
        </svg>
      </div>
      <div className='absolute  -bottom-10 -left-[100px] sm:-left-1/3 xl:bottom-10 xl:-right-[150%] translate-x-1/2 translate-y-1/2'>
        <img
          alt='rabbit'
          src={Rabbit.src}
          className='w-[65px] h-[87px] xl:w-[175px] xl:h-[212px]'
        />
      </div>
    </div>
  );
