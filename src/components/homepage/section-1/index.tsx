  ...
  return (
    <>
      ...
      <div className="bg-white h-[920px] flex items-center justify-center gap-[103px]">
        <div
          className="relative bg-[url(/svg/border-frame.svg)] w-[728px] h-[507px] py-[174px] px-[86px] bg-center bg-no-repeat inline-flex items-center justify-center">
          <div className="text-black text-[22px] leading-8">
          ...
          <AnimatePresence mode="wait">
            {showMenuDialog && (
              <motion.div key="menuDialog" variants={dialogVariants} initial="hidden" animate="visible" exit="exit">
                <MenuDialog />
              </motion.div>
            )}
          </AnimatePresence>
...
function MenuDialog() {
  return (
    <div className="absolute bottom-10 -right-20 bg-[#D7E5E9] rounded-xl py-[10px] px-3 w-[184px] h-auto">
    <div className="flex flex-col">
      <div
        className="bg-[#1AADB5] p-2 flex items-center justify-between text-sm leading-[120%] rounded text-white">
        Explain
      ...
      <div
        className="p-2 flex items-center justify-between text-sm leading-[120%] rounded">
        Give Examples
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
          <path
...
function ChatBotDialog() {
  return (
    <div
      className="absolute -bottom-2/3 -right-1/3 -translate-x-1/2 -translate-y-1/2 w-[420px] h-auto bg-[#E1EEE9] rounded-3xl drop-shadow-[0px_3px_7px_rgba(0,0,0,0.1)]">
      <div className="flex flex-col gap-4 py-6 px-4 ">
        <div className="flex items-center gap-1.5">
          <div className="w-6 h-6 rounded-full bg-[#E1EEE9] border border-[#000000]/10"/>
          <span className="text-base font-semibold leading-5">You</span>
        </div>
        <p className="text-sm leading-[150%]">Can you explain more about AI prompt?</p>
      </div>
      <div className="bg-[#CDDCD6] py-6 px-4">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-1.5">
            <div className="w-6 h-6 rounded-full bg-[#E1EEE9] border border-[#000000]/10"/>
            <span className="text-base font-semibold leading-5">AI Mentor</span>
          </div>
          <p className="text-sm text-[#2F2F2F] leading-[150%]">Can you explain more about AI prompt?</p>
          <div
            className="bg-[#F1FFFC] py-5 px-3 rounded-[4px] border-l-4 border-[#1AADB5] font-medium leading-[140%] text-[#484242]">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-[#776F69] leading-[18px]">Copy</span>
            </div>
            <div className="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
              ...
              <span className="text-sm text-[#776F69] leading-[18px]">Regenerate</span>
            </div>
          </div>
        </div>
      </div>
      <div className="flex flex-col gap-4 mt-[13px] py-4 px-2.5 ">
        <div
          className="bg-[#FFFFFF] rounded-[30px] py-2.5 px-4 h-11 border border-[#776F69]/28 flex items-center justify-between">
                <span className="text-[#838383] leading-[150%]">
                  Ask me anything...
                </span>
          <div className="bg-[#1AADB5] w-8 h-8 rounded-full flex items-center justify-center">
      ...
      <div className="absolute -bottom-0 -right-[120px] translate-x-1/2 translate-y-1/2">
        <NextImage alt="rabbit" src={Rabbit} width={175} height={212} />
      </div>
    </div>
  )
}
