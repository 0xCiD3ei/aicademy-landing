...
export default function Section1() {
  return (
    <>
      <div className='relative bg-secondary pt-[217px] pb-[157px] overflow-hidden'>
        ...
        <div className='absolute -bottom-10 -left-10 flex items-center overflow-hidden -rotate-[2.5deg]'>
          <div className='py-5 pr-5 bg-[#070612]'>
            <NextImage
              alt='thumbnail'
              src={Thumbnail}
        ...
        <div className='h-[1129px] flex items-center justify-center flex-col'>
          <h2 className='text-center text-primary-foreground font-semibold text-5xl'>
            What is{' '}
            <span className='font-dela-gothic-one text-[80px] leading-[120%] text-primary'>
              aicademy ?
            </span>
          </h2>
